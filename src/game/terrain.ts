...
export async function createTerrain(scene: Scene, shadowGenerator: ShadowGenerator) {
    // Terrain configuration
    const terrainConfig = {
        width: 800,           // Width of terrain (4x larger)
        height: 800,          // Depth of terrain (4x larger)
        subdivisions: 128,    // Higher = more detail, lower = better performance
        minHeight: 0,         // Minimum terrain height
        maxHeight: 30,        // Maximum terrain height
        heightmapPath: '/assets/textures/heatmap.png' // Path to your heatmap
    };
